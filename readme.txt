...
How to Use:                |
===========================|
Include SimpCon.h in your project. Then, you can either link your 
program to the DOSimple static library, dynamic library, or you can 
just compile to code right into your project! That's it!
...
void type(char *text, int wait=200)--A typewriter mimic! Can "type"
characters to the console window. Default settings types
five (5) letters a second, but that can be changed!
===========================|
Simple Console C++ Library |
Version 3.0b Final Release |
                           |
